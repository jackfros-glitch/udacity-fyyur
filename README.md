...
![alt text](https://github.com/jackfros-glitch/udacity-fyyur/blob/master/static/img/Homepage.png?raw=true)
...
Owners of Musiacl Venues could list out their venues for artists and shows organisers to book, to host musical shows by just filling out the required information
...
Artists who will like to be booked for a show can add their details using the form displayed below, after filling out the necessary details the artist can then
click the submit button to submit his information to the server then the server will then store the artist information in the database, if the form is not filled
...
ShowOrganiser or any one who wants to host a show can go to the post a show, and fill out the show form with all the required details and then submit it to be
...
This feature enables any one look up new venues and artists in the database easily by just typing the venue or artist name or just a related string, the inputed
word or string is looked up in the database and any venue or artist that has a corresponding match with the string will be returned to the user and if there
is no match no result is been returned

#### LEARNING MORE ABOUT A SPECIFIC ARTIST OR VENUE:

Fans of an artist, Lovers of a Venue, or Any one who wants to Know more about a venue or artist could just click on the specific artist or venue that they want to know more about, and all the details of that
particular artist or venue will be shown to the user
...
There are plenty of features that I would love to implement into the Fyyur webapp. Some of them are listed below:
